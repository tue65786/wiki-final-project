...
public class STRINGS {
	 ...
	 * Match the regular expression below and capture its match into backreference number 1 «(\{\{)»
	 * Match the character “{” literally «\{» Match the character “{” literally «\{» Match the
	 * regular expression below and capture its match into backreference number 2 «(.?[^}]*)» Match
	 * any single character that is not a line break character «.?» Between zero and one times, as
	 * many times as possible, giving back as needed (greedy) «?» Match any character that is NOT a
	 * “}” «[^}]*» Between zero and unlimited times, as many times as possible, giving back as
	 * needed (greedy) «*» Match the regular expression below and capture its match into
	 * backreference number 3 «(\}\})» Match the character “}” literally «\}» Match the character
	 * “}” literally «\}»
	 *
	 *
