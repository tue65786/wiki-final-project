...
/**
 * Debug methods for displaying database tables
...
public class DbUtils {
   ...
   public static String printJDBCExceptionMsg(SQLException ex) {
	  ...
	  String err = "";
	  for (Throwable e : ex) {
		 stackTracedAsString += StringUtils.throwableStackTraceToString(ex);
	  ...
	  return StringUtils.coalesce(err,stackTracedAsString,ex.toString(),"UNKNOWN");
   }
